#!/usr/bin/env python3
"""
Базовая версия Telegram бота для отслеживания TRC20 платежей
Без JobQueue для совместимости с Python 3.13
"""
...
- Минимальная сумма для отслеживания: 1 USDT
    ...
    def run(self):
        ...
        application = Application.builder().token(config.TELEGRAM_BOT_TOKEN).job_queue(None).build()
